      ...
      <div class="absolute inset-0">
        ...
        <% else %>
          <div class="flex h-full w-full items-center justify-center bg-base-200">
            <ClaperWeb.BrandComponents.logo
              variant={:mark}
              user={@event.user}
    ...
    <!-- Action Buttons (revealed on hover) -->
        ...
        >
          ...
          <.link
            ...
            phx-click="terminate"
            class="btn btn-outline flex-1 border-primary text-primary hover:border-primary hover:bg-primary hover:text-primary-content"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              class="h-5 w-5"
          ...
          <div class="flex items-center gap-2 ml-auto">
            <%= if @event.presentation_file.status == "done" && !Event.finished?(@event) do %>
              ...
              <.link
                ...
                phx-value-id={@event.uuid}
                phx-click="terminate"
                class="btn btn-outline border-primary text-primary hover:border-primary hover:bg-primary hover:text-primary-content"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  class="h-5 w-5"
